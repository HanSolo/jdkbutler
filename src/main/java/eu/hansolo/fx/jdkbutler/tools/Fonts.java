...
public class Fonts {
    ...
    static {
        try {
            sfProName            = Font.loadFont(Fonts.class.getResourceAsStream("/eu/hansolo/fx/jdkbutler/tools/SF-Pro.otf"), 10).getName();
            sfProTextLightName   = Font.loadFont(Fonts.class.getResourceAsStream("/eu/hansolo/fx/jdkbutler/tools/SF-Pro-Text-Light.otf"), 10).getName();
            sfProTextRegularName = Font.loadFont(Fonts.class.getResourceAsStream("/eu/hansolo/fx/jdkbutler/tools/SF-Pro-Text-Regular.otf"), 10).getName();
            sfProTextMediumName  = Font.loadFont(Fonts.class.getResourceAsStream("/eu/hansolo/fx/jdkbutler/tools/SF-Pro-Text-Medium.otf"), 10).getName();
            sfProTextBoldName    = Font.loadFont(Fonts.class.getResourceAsStream("/eu/hansolo/fx/jdkbutler/tools/SF-Pro-Text-Bold.otf"), 10).getName();
